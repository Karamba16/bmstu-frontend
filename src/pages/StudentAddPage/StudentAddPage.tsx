...
const StudentAddPage = () => {
    ...
    const updateStudent = async (student_id) => {
        ...
        const response = await api.put(`students/${student_id}/update/`, form_data, {
            headers: {
        ...
        <div className="add-page-wrapper">
            ...
            <div className="right">
                ...
                <div className="info-container">
                    ...
                    <CustomInput placeholder="ФИО" value={name} setValue={setName} />

                    <CustomTextarea placeholder="Факультет" value={faculty} setValue={setFaculty} />

                    <CustomInput placeholder="Группа" value={group} setValue={setGroup} />

                    <div className="buttons-container">

                        <CustomButton bg={variables.green} onClick={addStudent}>
                            Создать
                        </CustomButton>
