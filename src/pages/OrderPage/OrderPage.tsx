...
import {format_visa} from "../../utils/utils";
...
const OrderPage = () => {
    ...
    const cards = order.students.map(student  => (
    ...
    return (
        <div className="order-page-wrapper">
            ...
            <div className="order-students-wrapper">
                <div className="top">
                    <h3>{is_draft ? "Новый приказ" : "Заявка №" + order.id}</h3>
                </div>
                ...
                <div className="order-info-container">
                    ...
                    {[2, 3, 4].includes(order.status) && <span>Виза: {format_visa(order.visa)}</span> }
